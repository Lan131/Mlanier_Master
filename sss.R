...
To_be_added
ncol(To_be_added)
colnames(To_be_added)=c("date","Sum of availble hours","Sum of assigned hours","Sum of break hours","Sum of non call hours","Sum of negative exceptions worked","Sum of negative exceptions non working","Sum of positive exceptions","Number of employees") 
nrow(To_be_added)
